...
tff(count_value,axiom,count = 2.0).
...
tff(time_passed_value,axiom,time_passed = 10.0).

tff(num_rcvd_direction_in,axiom,num_rcvd(direction_in) = 1).

tff(num_rcvd_increment_in,axiom,num_rcvd(increment_in) = 1).

tff(val_rcvd_direction_in_value,axiom,val_rcvd_direction_in = $true).

tff(val_rcvd_increment_in_value,axiom,val_rcvd_increment_in = 1.0).

tff(next_state_conjecture,conjecture,(next_count = 3.0)&(next_increment = 1.0)&(next_countUp = $true)&(next_sigma = 5.0)&(val_output_count_out = 2.0)&(ta_out = 5.0)).
